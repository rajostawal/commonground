...
const ACTION_META: Record<string, { label: string; icon: typeof DollarSign; color: string }> = {
  ...
  shopping_item_buy: { label: "Bought item", icon: ShoppingCart, color: "var(--color-success)" },
  contract_create: { label: "Added contract", icon: FileText, color: "var(--color-accent)" },
};
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="flex items-center gap-3 px-4 py-3 border-b border-[var(--color-border-subtle)]">
        ...
        <h1 className="text-lg font-semibold text-[var(--color-text-primary)]">Activity Log</h1>
      </div>
